...
def post_chat(
    ...
    if not settings.anthropic_api_key:
        raise HTTPException(status_code=503, detail="AI analyst is not configured — set ANTHROPIC_API_KEY")
    ...
    try:
        answer = answer_question(
            db, artifact_dir, body.sport, body.league, body.question, settings.anthropic_api_key
        )
